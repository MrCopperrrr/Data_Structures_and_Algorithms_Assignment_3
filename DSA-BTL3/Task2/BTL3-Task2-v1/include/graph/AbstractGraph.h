...
//////////////////////////////////////////////////////////////////////
    ...
    virtual int inDegree(T vertex){
        ...
        if(node == nullptr) throw VertexNotFoundException("Vertex doesn't exist"); // Use 'vertex' directly
    ...
    virtual bool connected(T from, T to){
        ...
        if(fromNode == nullptr) throw VertexNotFoundException("Vertex doesn't exist"); // Use 'from' directly

        VertexNode* toNode = this->getVertexNode(to);
        if(toNode == nullptr) throw VertexNotFoundException("Vertex doesn't exist"); // Use 'to' directly
